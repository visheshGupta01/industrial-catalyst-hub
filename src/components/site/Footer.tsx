      ...
      <div className="container-page grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          ...
          <p className="mt-6 max-w-sm text-sm leading-relaxed opacity-70">
            A trusted procurement platform for industrial machinery, electrical systems, automation,
            and components. Serving manufacturers across 85 countries since 1987.
          </p>
        ...
        {[
          {
            title: "Catalog",
            links: ["Machinery", "Electrical", "Automation", "Pneumatics", "Instrumentation"],
          },
          {
            title: "Services",
            links: [
          ...
          {
            title: "Company",
            links: ["About FerroCore", "Industries", "Newsroom", "Careers", "Contact"],
          },
        ].map((col) => (
          <div key={col.title}>
