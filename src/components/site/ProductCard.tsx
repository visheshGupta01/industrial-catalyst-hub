      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 border border-border px-3 py-2 text-xs font-semibold uppercase tracking-wider hover:border-primary hover:text-primary"
          >
          ...
          >
            ...
            {user ? (addToCart.isPending ? "Adding..." : "Add to cart") : "Sign in"}
          </button>
        </div>
      </div>
    </article>
